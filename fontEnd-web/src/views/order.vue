  ...
  <div class="order-list">
    ...
    <el-table
      ...
      <el-table-column
        ...
        width="150">
        <template slot-scope="scope">
          <el-button :disabled="scope.row.order_status !== 1" @click="operatorOrder('edit',scope.row)" type="success" size="small">修改</el-button>
          <el-button :disabled="userInfo.role !== 1 || scope.row.order_status !== 1" @click="deleteOrderItem(scope.row)" type="danger" size="small">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
